// improvement: use smart pointer in CPavilion class to simplify mem managenment
#include <iostream>
#include <iomanip>
#include <vector>
#include <string>
...
double                  CPavilion::accumulate              ( double (CAnimal::*methPtr) ( void ) const ) const
{
  ...
  for ( vector<CSmartPtr<CAnimal > >::const_iterator it = m_Animals . begin (); it != m_Animals . end (); ++it )
    sum += ((**it) .* methPtr) ( );
  return sum; 
}    
//-------------------------------------------------------------------------------------------------
ostream               & operator <<                        ( ostream         & os, 
                                                             const CPavilion & x )
{
  for ( vector<CSmartPtr<CAnimal > >::const_iterator it = x . m_Animals . begin (); it != x . m_Animals . end (); ++it )
    os << **it;
